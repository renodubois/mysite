...
const LargeNav = () => {
  ...
  const topSection = (
    <div className={topSectionClasses.join(" ")}>
      <Link
        to="/"
        className="text-header-title no-underline text-3xl font-header font-black pt-1"
      >
        RenoInMO
      </Link>
    </div>
    ...
    <header className="bg-header-bg p-4 md:flex md:flex-col md:justify-center md:absolute md:h-screen md:w-2/12 hidden">
      ...
      <div className="ml-3 text-xl text-white md:text-right">
        <div className="m-2 ml-0">
          <a className="nav-link" href="https://blog.renoinmo.tv">
        ...
        <div className="flex justify-end">
          <a
            className="social-media-icon twitch"
            href="https://twitch.tv/RenoInMO"
          >
            <img
              className="w-6 m-2 ml-0"
              src={twitchLogo}
              alt="Twitch.tv Logo"
            />
          </a>
...
class Header extends React.Component {
  ...
  render() {
    ...
    let topIcon = (
      <div
        className="text-right cursor-pointer select-none h-6 w-6 pt-2 md:invisible"
        onClick={() => this.setMenuExpanded(true)}
      >
    ...
    if (menuExpanded) {
      topIcon = (
        <div
          className="text-right cursor-pointer select-none h-5 w-5 pt-2 md:invisible"
    ...
    const topSection = (
      <div className={topSectionClasses.join(" ")}>
        <div
          className="text-header-title no-underline text-3xl font-header font-black pt-1 cursor-pointer"
    ...
    if (!menuExpanded) {
      return (
        <>
          <LargeNav />
          <header className="bg-header-bg p-4 md:hidden">{topSection}</header>
        </>
      )
    }
    return (
          ...
          <div className="ml-3 text-xl text-white md:text-right">
            <div className="m-2 ml-0">
              <div
                ...
                onClick={e => this.navigateToPage(e, "/about")}
              >
                <span className="nav-item-text">about</span>
              </div>
            </div>
            <div className="m-2 ml-0">
              <div
                className="cursor-pointer"
                onClick={e => this.navigateToPage(e, "/projects")}
              >
                <span className="nav-item-text">projects</span>
              </div>
            </div>
            <div className="m-2 ml-0">
              <div
                className="cursor-pointer"
                onClick={e => this.navigateToPage(e, "/schedule")}
              >
                <span className="nav-item-text">schedule</span>
              </div>
            </div>
            <div className="m-2 ml-0">
              <div
                className="cursor-pointer"
                onClick={e => this.navigateToPage(e, "/contact")}
              >
                <span className="nav-item-text">contact</span>
              </div>
            </div>
